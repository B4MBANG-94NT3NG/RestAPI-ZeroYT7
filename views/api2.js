...
var creator = 'BAMBANG TRI RAHARJO' // ubah jadi nama lu
const listkey = ["BambangGans","KazuyaTeam","12345"]; // ubah apikey nya, tambah aja klo mau
...
var len = 15
 ...
 router.get('/addapikey', (req, res, next) => {
    ...
    if (!apikey) return res.sendFile(__path + '/views/invalidKey.html')
...
router.get('/cekapikey', async (req, res, next) => {
	...
	if(!apikeyInput) return res.sendFile(__path + '/views/invalidKey.html')
